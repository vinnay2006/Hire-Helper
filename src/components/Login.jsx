...
const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://hire-helper-1.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
      ...
      try {
      const response = await fetch('https://hire-helper-1.onrender.com/api/HelperAuth/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
